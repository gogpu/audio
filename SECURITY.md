...
1. **Private Security Advisory** (preferred):
   https://github.com/gogpu/audio/security/advisories/new
...
audio uses platform-native APIs via FFI. Users should be aware of:
...
- **GitHub Security Advisory**: https://github.com/gogpu/audio/security/advisories/new
- **Public Issues**: https://github.com/gogpu/audio/issues

---

**Thank you for helping keep gogpu/audio secure!**
